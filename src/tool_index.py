...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "get_workspace": "Return the absolute path of the active workspace folder the user is working in (file tools and bash/python are confined to it). Call this first when the user refers to 'the project'/'the code'/'this folder' without giving a path, instead of asking them.",
